...
func checkFlags() error {
	flPath := flag.String("path", "mdm/profiles", "path to profiles directory. If -repo is given, path is rooted in git repo")
	...
	if err = profiles.GenerateFromGit(*flRepo, *flCommit, *flPath, repl, *flOut); err != nil {
